...
if __name__ == "__main__":
    ...
    class JSONifiedState(EventScannerState):
        ...
        def __init__(self):
            self.state = None
            self.fname = "hopr_channels_events.json"
        ...
        def process_event(self, block_when: datetime.datetime, event: AttributeDict) -> str:
            ...
            self.state["blocks"][block_number][txhash][log_index] = e
    ...
    def run():
        ...
        abi = None
        with open(os.path.join('contracts', 'HoprChannels.abi')) as f:
            abi = json.load(f)
        HoprChannels = web3.eth.contract(abi=abi)
        ...
        scanner = EventScanner(
            ...
            state=state,
            events=[e for e in HoprChannels.events],
            filters={"address": '0xD2F008718EEdD7aF7E9a466F5D68bb77D03B8F7A'},
        ...
        CONTRACT_CREATION_BLOCK = 20307201
        start_block = max(state.get_last_scanned_block() - chain_reorg_safety_blocks, CONTRACT_CREATION_BLOCK)
